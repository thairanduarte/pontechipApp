...
mixin _$SignUpController on _SignUpControllerBase, Store {
  ...
  final _$isPasswordValidAtom =
      Atom(name: '_SignUpControllerBase.isPasswordValid');
  ...
  final _$arePasswordsEqualAtom =
      Atom(name: '_SignUpControllerBase.arePasswordsEqual');

  @override
  bool get arePasswordsEqual {
    _$arePasswordsEqualAtom.reportRead();
    return super.arePasswordsEqual;
  }

  @override
  set arePasswordsEqual(bool value) {
    _$arePasswordsEqualAtom.reportWrite(value, super.arePasswordsEqual, () {
      super.arePasswordsEqual = value;
    });
  }
  ...
  final _$cityAtom = Atom(name: '_SignUpControllerBase.city');
  ...
  final _$ufAtom = Atom(name: '_SignUpControllerBase.uf');
  ...
  final _$enablePasswordViewAtom =
      Atom(name: '_SignUpControllerBase.enablePasswordView');

  @override
  bool get enablePasswordView {
    _$enablePasswordViewAtom.reportRead();
    return super.enablePasswordView;
  }

  @override
  set enablePasswordView(bool value) {
    _$enablePasswordViewAtom.reportWrite(value, super.enablePasswordView, () {
      super.enablePasswordView = value;
    });
  }

  final _$enableConfirmPasswordViewAtom =
      Atom(name: '_SignUpControllerBase.enableConfirmPasswordView');

  @override
  bool get enableConfirmPasswordView {
    _$enableConfirmPasswordViewAtom.reportRead();
    return super.enableConfirmPasswordView;
  }

  @override
  set enableConfirmPasswordView(bool value) {
    _$enableConfirmPasswordViewAtom
        .reportWrite(value, super.enableConfirmPasswordView, () {
      super.enableConfirmPasswordView = value;
    });
  }
  ...
  void setEnablePasswordView() {
    final _$actionInfo = _$_SignUpControllerBaseActionController.startAction(
        name: '_SignUpControllerBase.setEnablePasswordView');
    try {
      return super.setEnablePasswordView();
    } finally {
  ...
  void setEnableConfirmPasswordView() {
    final _$actionInfo = _$_SignUpControllerBaseActionController.startAction(
        name: '_SignUpControllerBase.setEnableConfirmPasswordView');
    try {
      return super.setEnableConfirmPasswordView();
    } finally {
      _$_SignUpControllerBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void setCity(dynamic value) {
    final _$actionInfo = _$_SignUpControllerBaseActionController.startAction(
        name: '_SignUpControllerBase.setCity');
    try {
  ...
  void setUf(dynamic value) {
    final _$actionInfo = _$_SignUpControllerBaseActionController.startAction(
        name: '_SignUpControllerBase.setUf');
    try {
  ...
  void validateEqualPassword() {
    final _$actionInfo = _$_SignUpControllerBaseActionController.startAction(
        name: '_SignUpControllerBase.validateEqualPassword');
    try {
  ...
  Map<String, dynamic> toMap() {
    final _$actionInfo = _$_SignUpControllerBaseActionController.startAction(
        name: '_SignUpControllerBase.toMap');
    try {
      return super.toMap();
    } finally {
      _$_SignUpControllerBaseActionController.endAction(_$actionInfo);
