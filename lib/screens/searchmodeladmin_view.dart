...
import 'package:potenchip/screens/model_view_admin.dart';
...
class SearchModelViewAdmin extends StatefulWidget {
  final UserController userController;
  SearchModelViewAdmin({Key key, this.userController}) : super(key: key);
  

  @override
  _SearchModelViewAdminState createState() => _SearchModelViewAdminState();
}

class _SearchModelViewAdminState extends State<SearchModelViewAdmin> {
                                    ...
                                    children: [
                                      ...
                                      CustomButtonWidget(
                                          ...
                                          onPressed: () async {
                                            ...
                                            QuerySnapshot test = await FirebaseFirestore.instance.collection("Users").where("workingCities",arrayContains : "Rio do Sul").get();
                                            test.docs.forEach((element) { 
                                              print(element["name"]);
                                              print(element["priceChange"]);
                                            });
